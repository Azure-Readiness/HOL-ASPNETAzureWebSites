...
> **Note:** A Visual Studio 2012 version of this Hands-on Lab can be found in the latest build of the [Windows Azure training kit](http://bit.ly/WindowsAzureTK) or in [GitHub](https://github.com/WindowsAzure-TrainingKit/HOL-ASPNETAzureWebSitesVS2012).
...
- [Microsoft Web Publish for Visual Studio 2010 (August 2012)][0]
